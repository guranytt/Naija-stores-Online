...
const welcome = buildMasterLayout(
  ...
  \`
    <h3 style="margin: 0 0 16px; color: #0f172a; font-size: 20px; font-weight: 800;">Hello {{ .Data.name | default 'Shopper' }},</h3>
    ...
    \${sharedButtonComponent("Start Shopping Now", "{{ .SiteURL }}")}
  \`
);
...
const orderConf = buildMasterLayout(
  ...
  \`
    ...
    <p style="margin: 0 0 14px;">Greetings {{ .Data.customerName | default 'Shopper' }}, we have secured your order <strong>#{{ .Data.orderId }}</strong>.</p>
    ...
    <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 18px; padding: 22px; margin: 24px 0;">
      ...
      <p style="margin: 0; font-size: 13px; color: #475569; line-height: 1.45;">{{ .Data.shippingAddress | default 'Lagos, Nigeria' }}</p>
...
const orderShipped = buildMasterLayout(
  ...
  \`
    ...
    <p style="margin: 0 0 14px;">Greetings {{ .Data.customerName | default 'Shopper' }}, the platform systems have logged an update for order <strong>#{{ .Data.orderId }}</strong>.</p>
    ...
    <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 16px; padding: 20px; margin: 24px 0;">
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size: 13px; line-height: 1.5;">
        <tr>
          ...
          <td align="right" style="color: #0f172a; font-weight: bold; font-family: monospace; padding: 4px 0;">{{ .Data.trackingId | default 'TRACK-123456' }}</td>
        </tr>
      </table>
    </div>

    \${sharedButtonComponent("Track Shipment Progress", "https://www.naijaonlinestores.com.ng/dashboard")}
  \`
);
