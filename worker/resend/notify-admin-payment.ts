...
export default {
  async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
    ...
    // Check idempotency under admin notifier (we log under customer's user_id or admin user_id)
    // Using order.customer_id is safe for checking since it matches the order
