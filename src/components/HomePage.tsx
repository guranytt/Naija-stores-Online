 ...
 * - Gold accents (#C5A059) and deep navy theme (#001B44)
 * - Tailwind CSS for styling
 */
const HomePage = ({ onNavigate }: { onNavigate?: (screen: string) => void }) => {
  return (
    <div className="bg-[#0c0f10] text-white font-serif selection:bg-[#C5A059]/30 rounded-3xl overflow-hidden mt-8 mb-16 shadow-2xl border border-white/5">

      {/* Hero Section with Glassmorphism */}
      <section className="relative pt-32 pb-20 px-6 lg:pt-48 lg:pb-32 overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 opacity-30">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#001B44] rounded-full blur-[120px]" />
          <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#C5A059]/10 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10 max-w-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-16 shadow-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6">
              Delivered to <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C5A059] to-[#E8D09E]">
                Your Door.
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-grow flex items-center bg-white/5 border border-white/10 rounded-2xl px-6 py-4 focus-within:border-[#C5A059]/50 transition-all">
              ...
              <button className="bg-[#C5A059] hover:bg-[#E8D09E] text-[#001B44] font-bold px-10 py-4 rounded-2xl transition-all shadow-lg shadow-[#C5A059]/20 flex items-center justify-center space-x-2">
                <span>Search</span>
              </button>
            </div>
          ...
          <div className="flex justify-between min-w-[800px] lg:min-w-0">
            {[
              ...
              <button key={cat.label} className="group flex flex-col items-center space-y-4 px-6 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all">
                <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-2xl group-hover:bg-[#C5A059]/10 group-hover:border-[#C5A059]/30 transition-all">
                  {cat.icon}
                </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            <div>
              <p className="text-[#C5A059] text-[10px] uppercase tracking-[0.3em] font-bold mb-2">Curated Selection</p>
              <h2 className="text-4xl font-bold">Our Premier Vendors</h2>
            </div>
            <button className="flex items-center space-x-2 text-white/40 hover:text-[#C5A059] transition-colors text-xs uppercase tracking-widest font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[700px]">
            ...
            <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-[32px] border border-white/10">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#001B44] via-[#001B44]/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-10">
                <div className="bg-[#C5A059] text-[#001B44] px-3 py-1 rounded text-[10px] font-bold uppercase mb-4 inline-block">Platinum Vendor</div>
                ...
                <button className="flex items-center space-x-2 text-[#C5A059] hover:text-white transition-colors">
            ...
            <div className="md:col-span-2 relative group overflow-hidden rounded-[32px] border border-white/10">
              ...
              <div className="absolute inset-0 bg-[#001B44]/40" />
              <div className="absolute inset-0 flex flex-col justify-center px-10">
                ...
                <button className="text-[#C5A059] text-[10px] font-bold uppercase tracking-[0.2em]">Browse Inventory</button>
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden rounded-[32px] border border-white/10">
              ...
              <div className="absolute inset-0 bg-[#001B44]/20 p-8 flex flex-col justify-end">
