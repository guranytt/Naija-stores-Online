...
const MOCK_CATEGORIES = [
  { id: "cat_1", name: "Fashion", description: "Trendy clothes", image_url: "", icon_name: "Shirt", item_count: 0, subcategories: [], status: "active" },
  { id: "cat_2", name: "Electronics", description: "Gadgets", image_url: "", icon_name: "Laptop", item_count: 0, subcategories: [], status: "active" }
];
