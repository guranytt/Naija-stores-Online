...
const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    itemCount: 0,
    subcategories: ["Food Cupboard", "Beverages", "Fresh Food", "Household Supplies", "Snacks"],
    status: "active"
  },
  {
    id: "cat_computing",
    ...
    iconName: "Laptop",
    itemCount: 0,
    subcategories: ["Laptops", "Desktops", "Computer Accessories", "Printers", "Software"],
    status: "active"
  },
  {
    id: "cat_electronics",
    name: "Electronics",
    description: "Home appliances, TVs, and audio.",
    image: "https://images.unsplash.com/photo-1550009158-9effb64fda5e?q=80&w=2000&auto=format&fit=crop",
    iconName: "Tv",
    itemCount: 0,
    subcategories: ["Televisions", "Audio & Sound Systems", "Home Appliances", "Generators & Power", "Cameras"],
    status: "active"
  },
  {
    id: "cat_fashion",
    name: "Fashion",
    description: "Men, women, and kids' clothing and shoes.",
  ...
  },
  {
    id: "cat_cars",
    name: "Automobiles",
    description: "Cars and auto accessories.",
    image: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?q=80&w=2000&auto=format&fit=crop",
    iconName: "Car",
    itemCount: 0,
    subcategories: ["Cars", "Motorcycles", "Vehicle Accessories", "Vehicle Tracking", "Tires & Tools"],
    status: "active"
  }
];
...
export default function App() {
  ...
  useEffect(() => {
    const handleUrlChange = () => {
      ...
      const seoCategories = ["electronics", "fashion", "phones", "laptops", "beauty", "home-kitchen", "sports", "gaming", "groceries", "computing", "cars", "automobiles"];
  ...
  useEffect(() => {
    ...
    // Dynamic Image for OG / Twitter
    let ogImage = "https://res.cloudinary.com/dqpjjfsya/image/upload/v1780680415/IMG_20260605_180310_438_ztopwj.png";
    if (currentScreen === "details" && selectedProductId) {
       const prod = products.find(p => p.id === selectedProductId);
       if (prod && prod.image) ogImage = prod.image;
    } else if (currentScreen === "vendor" && selectedVendorSlug) {
       const vend = vendors.find(v => slugifyLocal(v.name) === selectedVendorSlug || v.id === selectedVendorSlug);
       if (vend && vend.avatar) ogImage = vend.avatar;
    }
  ...
  const handleUpdateCategories = (newCats: Category[]) => {
    ...
    try {
      ...
      // Save all new/pending cats to supabase to link product IDs correctly
      newCats.forEach(cat => {
        saveSupabaseRecord("categories", cat);
      });
    } catch (e) {
      console.error(e);
    }
